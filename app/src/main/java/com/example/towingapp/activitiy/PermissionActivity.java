package com.example.towingapp.activitiy;
...
import com.example.towingapp.databinding.ActivityLocationBinding;
...
public class PermissionActivity extends AppCompatActivity {
    ...
    private void updateUI() {
        if (state == STATE.NA) {
            binding.locationLBLTitle.setText("0");
            binding.locationLBLContent.setText("NA");
            binding.locationLBLProgress.setText("-/-");
            binding.locationBTNBack.setVisibility(View.INVISIBLE);
            binding.locationBTNNext.setVisibility(View.INVISIBLE);
        } else if (state == STATE.LOCATION_DISABLE) {
            binding.locationLBLTitle.setText("Enable location services");
            binding.locationLBLContent.setText("The app samples your location.\nPlease enable location services (GPS).");
            binding.locationLBLProgress.setText("1/4");
            binding.locationBTNNext.setOnClickListener(v -> {
                enableLocationServicesProgrammatically();
            });
            binding.locationBTNNext.setText("Turn On");
            ...
            binding.locationBTNNext.setText("Allow");
            binding.locationBTNBack.setVisibility(View.VISIBLE);
            binding.locationBTNNext.setVisibility(View.VISIBLE);
            ...
            binding.locationLBLTitle.setText("4");
            binding.locationLBLContent.setText("LOCATION_SETTINGS_PROCCESS");
            binding.locationLBLProgress.setText("");
            binding.locationBTNBack.setVisibility(View.INVISIBLE);
            binding.locationBTNNext.setVisibility(View.INVISIBLE);
            ...
            binding.locationBTNNext.setText("Close");
            binding.locationBTNBack.setVisibility(View.INVISIBLE);
            binding.locationBTNNext.setVisibility(View.VISIBLE);
        }
    }
    ...
    private final ActivityResultLauncher<String> requestPermissionLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(), isGranted -> {
                if (isGranted) {
                    ...
                    if (shouldShowRequestPermissionRationale(checkForMissingPermission(PermissionActivity.this))) {
                        Snackbar.make(findViewById(android.R.id.content),
                                ...
                                .setAction(R.string.settings, new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        requestPermissionLauncher.launch(checkForMissingPermission(PermissionActivity.this));
                                    }
                                })
                                .show();
                    } else {
                        buildAlertMessageManuallyBackgroundPermission(checkForMissingPermission(PermissionActivity.this));
                    }
                }
            });
